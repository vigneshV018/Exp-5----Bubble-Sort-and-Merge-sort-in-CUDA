...
void mergeSortCPU(int *arr, int n) {
    ...
    auto end = std::chrono::high_resolution_clock::now();
    std::chrono::duration duration = end - start;
    printf("Merge Sort (CPU) took %ld milliseconds\n", duration.count());
}
...
<img width="1751" height="384" alt="image" src="https://github.com/user-attachments/assets/68c1f9a2-5168-413d-a520-10dabef3a238" />


## RESULT:

Thus, the program has been executed using CUDA to compare CPU and GPU implementations of Bubble Sort and Merge Sort. It is observed that CPU Bubble Sort took 297763140 nanoseconds (297.76 milliseconds), GPU Bubble Sort took 165.333725 milliseconds, CPU Merge Sort took 1762802 nanoseconds (1.76 milliseconds), and GPU Merge Sort took 340.994568 milliseconds. Hence, for this dataset, GPU Bubble Sort performed faster than CPU Bubble Sort, while CPU Merge Sort performed faster than GPU Merge Sort.
